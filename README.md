...
I made this fork with simplicity and an easy-to-use UI in mind for my daily usage of a simple SuperUser management app with module handling capabilities.
